...
public class SpendingBreakdownIntroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RelativeLayout _rootLayout = (RelativeLayout) inflater.inflate(R.layout.fragment_spending_breakdown_intro, container, false);
        Button _begin = (Button) _rootLayout.findViewById(R.id.spending_begin);
